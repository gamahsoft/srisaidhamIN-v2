    ...
    <div className="max-w-screen-2xl mx-auto px-3 sm:px-10">
      ...
      <div className="px-6 py-10 lg:py-20 bg-emerald-50 h-screen flex flex-wrap content-center">
        <div className="block justify-items-stretch mx-auto items-center text-center">
          <img width={650} height={450} src="/404.svg" alt="page not found" />
          ...
          <Link to="/">
            <a className="md:text-sm leading-4 inline-flex items-center cursor-pointer transition ease-in-out duration-300 font-semibold text-center justify-center border-0 border-transparent rounded-md placeholder-white focus-visible:outline-none focus:outline-none bg-orange-400 text-white px-5 md:px-6 lg:px-8 py-3 md:py-3.5 lg:py-3 hover:text-white hover:bg-slate-700 h-12 mt-6 text-sm lg:text-base w-full sm:w-auto">
              Back to Home
            </a>
          </Link>
        </div>
