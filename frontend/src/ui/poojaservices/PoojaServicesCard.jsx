    ...
    <div className="w-72 bg-white shadow-lg p-4 rounded-xl duration-500 hover:scale-105 hover:shadow-xl">
      <div className="relative overflow-hidden">
        ...
        <div className="flex items-center justify-between mt-4 ">
          ...
          <button className="bg-orange-400 text-white text-center text-md py-2 px-4 rounded-full font-bold hover:bg-gray-800">
            DONATE
          </button>
        </div>
      </div>
